...
/**
 * Form Request voor het valideren van een nieuwe afspraak.
 *
 * De rolcontrole (Admin/Medewerker) gebeurt in de route-middleware,
 * daarom mag authorize() hier true teruggeven.
 */
class AfspraakToevoegenRequest extends FormRequest
{
    /**
    ...
    /**
     * De validatieregels voor het toevoegen van een afspraak.
     *
