    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-2">
                Voeg een nieuw product toe aan uw salon
            </p>
        </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->Id }}" @selected(old('CategorieId') == $category->Id)>
                                    {{ $category->Naam }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        @forelse($suppliers as $supplier)
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="leveranciers[]" 
                                    value="{{ $supplier->Id }}"
                                    @checked(in_array($supplier->Id, old('leveranciers', [])))
